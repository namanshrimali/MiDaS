...
from datasets.LoadImageAndDepth import LoadImageDepthAndLabels
from midas.midas_net import MidasNet
from tqdm import tqdm
import torch.optim as optim
import torch.nn as nn

def train(batch_size, weight_path, epochs):
    net_w, net_h = 384, 384
    ...
    model = MidasNet(weight_path, non_negative=True).to(device).train()
